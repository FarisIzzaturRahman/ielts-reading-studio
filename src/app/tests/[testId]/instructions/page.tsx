    ...
    <AppShell>
      <section className="mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="test-panel p-8">
          ...
          <p className="mt-3 leading-7 text-slate-600">{test.topic}</p>
          <dl className="mt-6 grid gap-4 sm:grid-cols-4">
            <div className="rounded-md bg-slate-50 p-4">
              <dt className="text-sm text-slate-500">Passages</dt>
              <dd className="mt-1 text-xl font-semibold">{test.passages.length}</dd>
            </div>
            <div className="rounded-md bg-slate-50 p-4">
            ...
            <div className="rounded-md bg-slate-50 p-4">
              ...
              <dd className="mt-1 text-xl font-semibold">{test.targetBand}</dd>
            </div>
          </dl>
          <div className="mt-8 border-t border-slate-200 pt-6">
            <h2 className="text-xl font-semibold text-slate-950">Instructions</h2>
            <ul className="mt-4 space-y-3 text-sm leading-6 text-slate-700">
              <li>Read the passages and answer all 20 questions.</li>
