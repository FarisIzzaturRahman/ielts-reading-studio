        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-3xl leading-7 text-slate-600">
              Fifteen free, original mini simulations for self-learners. Choose an Academic Reading topic,
              continue an unfinished attempt, or retake a completed test without creating an account.
            </p>
          </div>
